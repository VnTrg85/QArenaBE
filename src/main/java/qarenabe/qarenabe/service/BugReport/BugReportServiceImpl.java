...
public class BugReportServiceImpl implements BugReportService {
    ...
    public List<BugReportDTOSecond> getListBugByProject(Long projectId) {
       try {
            ...
            List<BugReportDTOSecond> resBugReports = new ArrayList<>();
            ...
            for (BugReport bugReport : bugReports) {
                if(bugReport.getTestProject().getId() == projectId) {
                    ...
                    BugReportDTOSecond bugReportDTO = new BugReportDTOSecond(bugReport.getId(), bugReport.getTitle(), bugReport.getStatus(), bugReport.getReported_at(), bugReport.getBugType().getIcon_link(), bugReport.getBugType().getName(), user);
